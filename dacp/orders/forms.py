...
class OrderForm(forms.Form):
    ...
    # Ініціалізація замовлення, форма для замовлення0. Якщо користувач зареєстрвоаний, то в кожне поле будемо намагатися поставити дані які він записав при реєстрації
